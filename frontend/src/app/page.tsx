      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col px-4 pb-16 pt-10 md:pt-16">
        ...
        <nav className="flex flex-wrap items-center justify-between gap-4 animate-fade-in">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/chat-tracking"
              className="rounded-full bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:bg-indigo-500 cursor-pointer"
            >
              Chat Tracking
            </Link>
            <Link
